...
public class JwtTokenProvider {
	...
	public boolean validateToken(String token){
        try{
            ...
            throw new InvalidCredentialsException("Expired JWT token");
        } catch (UnsupportedJwtException ex) {
            throw new InvalidCredentialsException("Unsupported JWT token");
        } catch (IllegalArgumentException ex) {
            throw new InvalidCredentialsException("JWT claims string is empty.");
        }
        catch(Exception e)
        {
